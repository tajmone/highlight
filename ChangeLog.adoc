...
19.07.2019
  ...
  - added `KeywordFormatHints`, `Priority` and `Constraints` elements to syntax regex definitions
  ...
  - CLI: added option `--two-pass` (https://gitlab.com/saalen/highlight/issues/112)
