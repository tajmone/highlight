...
22.10.2019
  ...
  - fixed default color output in BBCode (https://gitlab.com/saalen/highlight/issues/134)
  - added author hints in themes and language definitions 
  - GUI: replaced multibyte path trace window by startup hint if NtfsDisable8dot3NameCreation is set
